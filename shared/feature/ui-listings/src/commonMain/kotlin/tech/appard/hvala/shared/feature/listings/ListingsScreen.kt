...
private fun ListingsScreenPreview() {
    HvalaTheme {
        ListingsContent(
            state = ListingsUiState(
                categories = listOf(
                    ListingCategory("clothes", "Одежда"),
                    ListingCategory("auto", "Авто"),
                    ListingCategory("realty", "Недвижимость"),
                    ListingCategory("electronics", "Электроника"),
                    ListingCategory("furniture", "Мебель"),
                ),
